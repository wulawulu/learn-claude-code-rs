...
| 21 | [`s21_agent_evaluation`](./s21_agent_evaluation) | Agent Evaluation | Add eval cases, repeatable environments, observable trajectories, deterministic assertions, and LLM-as-a-Judge to the simple s20 agent. Docs: [`s21.md`](./s21_agent_evaluation/s21.md). |
